...
public class CharacterAnimatorController
{
    ...
    readonly static Dictionary<int, CharacterPredictedData.LocoState> s_charLocoStateHashes = new Dictionary<int, CharacterPredictedData.LocoState>() {
        //{ Animator.StringToHash("Grounded"), CharacterPredictedData.LocoState.Stand },
        { Animator.StringToHash("Grounded"), CharacterPredictedData.LocoState.GroundMove },
        { Animator.StringToHash("Jump"), CharacterPredictedData.LocoState.Jump },
