...
public class MovableSystemServer
{
    ...
    public void Update() {
        ...
        GameObject prefab = (GameObject)m_BundledResourceManager.GetSingleAssetResource(Game.Instance.movableBoxPrototype);

        var movable = m_GameWorld.Spawn<Movable>(prefab, new Vector3(x * 3, 30, z * 3), UnityEngine.Random.rotation);  // level_00: new Vector3(-20+x*3,10,-10+z*3)
