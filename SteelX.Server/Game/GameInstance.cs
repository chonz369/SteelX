...
namespace GameServer.Game
{
    ...
    public class GameInstance
    {
        ...
        private uint GetTeamForNewUser()
        {
            ...
            {
                var numSessions = _sessions.Count;

                return (uint) numSessions;
            }
            else if (GameType == GameType.DefensiveBattle)
            {
                return 0;
            }
            else
        ...
        public void SpawnUnit(Unit unit, ExteelUser user)
        {
            ...
            // Set unit Location
            // TODO: Spawn maps?
            unit.WorldPosition = new Vector3(3000, -3000, 3000);
